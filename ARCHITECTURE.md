...
| `/api/admin/*` | `routes/admin.py` | Queues, lifecycle, org erase, compose email, late-add org to a drop, drop config/tracker/hide/unhide, shipments, table inspect/patch, health, impersonate |
