...
Fixed in Phase C (`spa-role-tours`): public `/for-orgs` and `/for-brands` with
requirements, numbered flow, stylized frames, and home/footer/login/brand-apply
links. Set `closed_in` at the fixing commit.
